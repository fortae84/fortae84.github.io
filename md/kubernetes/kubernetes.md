...
- ReplicaSets
  ...
  ![이미지](./replicaset/1.png)

  ![이미지](./replicaset/2.png)
...
# Ubuntu기반 Kubernetes Master & Worker Node 구성
...
- 호스트명 변경 (sudo hostnamectl set-hostname 호스명)
